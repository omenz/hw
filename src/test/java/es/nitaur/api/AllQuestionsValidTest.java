...
public class AllQuestionsValidTest {
    ...
    public static final String UPDATE_QUESTION_API = "/api/quiz/question";
    public static final String GET_ALL_QUESTIONS_API = "/api/quiz/question";
    ...
    public void questionsAreNotSavedWithEmptyQuestionText() throws Exception {
        ...
        restTemplate.put(UPDATE_QUESTION_API, questionsToUpdate);
